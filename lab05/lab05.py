...
def flatten(s):
    ...
    flattened_list = [flatten(l) for l in s]
...
def closer_city(lat, lon, city_a, city_b):
    ...
    if distance(city_x, city_a) > distance(city_x, city_b):
...
def berry_finder(t):
    ...
    if label(t) == "berry":
        return True
    total = [berry_finder(b) for b in branches(t)]
...
def find_path(t, x):
    ...
    leaves = [find_path(b,x) for b in branches(t) ]
